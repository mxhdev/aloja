...
translate_bsbm() {
 ...
 # execute_cmd_master "$bench_name" "cd $(get_local_apps_path)/s2rdf; export PATH=$PATH:$(get_java_home)/bin; python translateBSBM.py -s $(get_local_apps_path)/sparql/ -t sql/ -u $scale_ub"
